  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primaryOutline2: "bg-transparent text-sky-300 hover:bg-white",
        secondary: "bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-red-700 border-b-4 active:border-b-0",
        third: "bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-700 border-b-4 active:border-b-0",
        ...
        ghost2: "bg-transparent text-red-900 border-transparent border-0 hover:bg-slate-100",
        sidebar: "bg-transparent text-red-900 border-2 border-transparent hover:bg-slate-100 transition-none",
        sidebarOutline: "bg-red-900/30 text-pink-100 border-red-500 border-2 hover:bg-red-500/30 transition-none"
      },
      size: {
